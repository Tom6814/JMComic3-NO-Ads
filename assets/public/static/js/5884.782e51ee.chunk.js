  ...
  [5884],
  {
            ...
            return (0, d.jsx)(
              i.A,
              {
                ...
                onClose: (t, r) => {
                  var o;
                  "clickaway" !== r &&
                    ((o = e.key), s((e) => e.filter((e) => e.key !== o)));
                },
    ...
    3492: (e, t, s) => {
      ...
      const f = (e) => {
        const {
          ...
          O = (0, i.j)(),
          { favoriteList: z } = (0, i.G)((e) => e.member),
          D = (0, o.useRef)(null),
          q = (0, o.useRef)(!1),
          ...
          U = () => {
            ((q.current = !0), clearTimeout(D.current));
          },
          B = async (e, s) => {
            if ("like" === e) {
              if (R.includes(s))
              ...
              const e = await O((0, m.c1)({ id: s })).unwrap(),
                { code: r, msg: o, status: a } = e.data;
              200 === r && F(o, "success" !== a ? "error" : "success");
            }
            if ("mark" === e)
              if (f) {
                (W(!0),
                    ...
                    G((s) => {
                      const o = s[e] || [],
                        a = o.includes(t)
                          ? o.filter((e) => e !== t)
                          : [...o, t];
                      return (0, r.A)((0, r.A)({}, s), {}, { [e]: a });
                    });
                  })("mark", s));
                const e = await O((0, m.df)(s)).unwrap(),
                  { code: t, data: o } = e,
                  a = "ok" !== o.status ? "error" : "success";
                if ("ok" === o.status)
                  switch (o.type) {
                    case "add":
                    case "edit":
                    case "move":
                      (I((e) =>
                        (0, r.A)((0, r.A)({}, e), {}, { aid: s, alert: !1 }),
                      ),
                        L((0, r.A)((0, r.A)({}, E), {}, { folder: !0 })));
                      break;
                    case "remove":
                      I((e) => (0, r.A)((0, r.A)({}, e), g.x));
                  }
                F(o.msg, a);
              } else
                (F(t("login.please_login"), "error"),
                  L((0, r.A)((0, r.A)({}, E), {}, { login: !0 })));
          },
          H = () => {
            O((0, h.a9)("favoriteList"));
            const { folder_id: e, o: t } = T;
            O((0, m.an)({ page: 1, folder_id: e, o: t }));
          },
          K = async (e) => {
            (W(!0),
              "del" === e && L((0, r.A)((0, r.A)({}, E), {}, { alert: !0 })));
            const { folder_id: s, folder_name: o, aid: a } = T;
            if ("" !== o) {
              const t = await O(
                  (0, m.Je)({ type: e, folder_id: s, folder_name: o, aid: a }),
                ).unwrap(),
                { status: r, msg: i } = t.data;
              r && i && F(i, "ok" !== r ? "error" : "success");
            ...
            T.alert &&
              (0, b.jsx)(x.Fc, {
                ...
                handleDelWatchComic: async () => {
                  if ("del_watch_history" === T.type && "" !== T.aid) {
                    const e = await O((0, m.Zx)(T.aid)).unwrap(),
                      { status: t, msg: s } = e;
    ...
    3344: (e, t, s) => {
      ...
      const v = o.forwardRef(function (e, t) {
          return (0, j.jsx)(h.A, (0, r.A)({ direction: "up", ref: t }, e));
        }),
        k = (e) => {
          const {
              dialogOpen: t,
            ...
            [N, _] = (0, o.useState)(null),
            C = Boolean(N),
            { t: S } = (0, f.Bd)(),
            T =
              (null === w || void 0 === w ? void 0 : w.length) > 0 &&
              h.tags_select === w.toString(),
            I = (e, o) => {
              "backdropClick" !== o &&
                s((0, r.A)((0, r.A)({}, t), {}, { folder: !1 }));
            };
                            ...
                            (0, j.jsxs)(l.A, {
                              ...
                              children: [
                                (0, j.jsx)("span", {
                                  className: "pr-10",
                                  children:
                                    h.folder_name || S("member.select_folder"),
                                }),
                                (0, j.jsx)(u.A, {
    ...
    6733: (e, t, s) => {
      ...
      const f = o.forwardRef(function (e, t) {
          return (0, b.jsx)(u.A, (0, r.A)({ direction: "up", ref: t }, e));
        }),
        j = (e) => {
          const {
              t: t,
                ...
                (0, b.jsxs)(c.A, {
                  ...
                  children: [
                    ...
                    (0, b.jsxs)(h.A, {
                      ...
                      children: [
                        (0, b.jsx)("img", {
                          src: A.image ? A.image : "/images/help_cover.png",
                          alt: "help_cover",
                          className: "w-10/12 m-auto",
                        }),
                        A.text_sections.map((e, t) =>
                          (0, b.jsxs)(
                            "div",
                            {
                              children: [
                  ...
                  children: [
                    ...
                    (0, b.jsxs)(h.A, {
                      children: [
                        ...
                        (0, b.jsx)("div", {
                          children: A.text_sections.map((e, t) =>
                            (0, b.jsxs)(
                              "div",
                              {
                                className: "mt-2",
                  ...
                  children: [
                    ...
                    (0, b.jsx)(h.A, {
                      ...
                      children: (0, b.jsx)("div", {
                        children: A[0].text_section.map((e, s) =>
                          (0, b.jsxs)(
                            "div",
                            {
                              className: "mt-3",
    ...
    5884: (e, t, s) => {
      ...
      const F = () => {
        var e, t, s, F, L;
        const { config: E } = (0, i.H)(),
          { setting: M, logined: O } = E,
          z = (0, a.Zp)(),
          { t: D } = (0, c.Bd)(),
          { snackbars: q, setSnackbars: R, showSnackbar: P } = (0, S.q)(),
          W = D("search.radio_option", { returnObjects: !0 }),
          Q = (0, o.useRef)(null),
          G = (0, _.h8)(),
          J = (0, _.Kb)(),
          Y = (0, l.j)(),
          {
            searchList: U,
            hotTagsList: B,
            randomRecommendList: H,
            isLoading: K,
            isRefreshing: Z,
          } = (0, l.G)((e) => e.search),
          [V, X] = (0, o.useState)({ search: !1, folder: !1 }),
          [$, ee] = (0, o.useState)({ search: !1 }),
          te = (0, a.zy)(),
          se = (0, T.bs)(),
          re =
            null !== (e = new URLSearchParams(te.search).get("filter")) &&
            void 0 !== e
              ? e
              : "",
          oe = sessionStorage.getItem("fromPage") || "/",
          ae = sessionStorage.getItem("searchQuery"),
          [ie, le] = (0, o.useState)(() => {
            const e = localStorage.getItem("search");
            return e ? JSON.parse(e) : [];
          }),
          de = Math.floor(
            Math.random() * (null === H || void 0 === H ? void 0 : H.length),
          ),
          ne = H && (null === (t = H[de]) || void 0 === t ? void 0 : t.id),
          [ce, me] = (0, o.useState)(1),
          { ref: he, inView: xe } = (0, n.Wx)(),
          ue =
            (null === (s = U.list) || void 0 === s ? void 0 : s.length) > 0
              ? Math.ceil(U.total / 80)
              : 0,
          ge = ce <= ue && ue > 1,
          pe = {
            start: !1,
          ...
          [be, fe] = (0, o.useState)(pe),
          [je, ve] = (0, o.useState)(C.x);
        (0, o.useEffect)(() => {
          const e = sessionStorage.getItem("searchSort");
          if (!e) return;
          const t = G.find((t) => t.title === e);
          t && fe((e) => (0, r.A)((0, r.A)({}, e), {}, { sort: t }));
        }, []);
            ...
            let e =
              ...
              a =
                arguments.length > 5 && void 0 !== arguments[5]
                  ? arguments[5]
                  : be.sort.key;
            (Y((0, y.FP)({ isLoading: !0, isLoadMore: e, isRefreshing: t })),
              e || me(1),
              setTimeout(async () => {
                const e = await Y(
                  (0, w.BN)({ search_query: o, o: a, page: s }),
                ).unwrap();
                e.redirect_aid && z("/comic/detail?id=".concat(e.redirect_aid));
              }, r));
          },
          [be],
        );
        ((0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            re !== ae
              ? re && re !== be.query
                ? Ae(re)
                : "" === re && fe((e) => (0, r.A)((0, r.A)({}, e), pe))
              : fe((e) =>
                  (0, r.A)((0, r.A)({}, e), {}, { start: !0, query: ae }),
                );
          }, [re]));
        const Ae = function (e) {
          let t =
          ...
          if ("\u6210\u4ebaA\u6f2b" === be.selected)
            (me(1),
              ke(!1, !1, 1, 0, e, t),
              fe((t) => (0, r.A)((0, r.A)({}, t), {}, { start: !0, query: e })),
              ye(e, "add"),
              z("/search?filter=".concat(encodeURIComponent(e))));
          else {
            const t = "\u5c0f\u96fb\u5f71" === be.selected ? "movie" : "video";
            z(
              "/movies?videoType="
                .concat(t, "&searchQuery=")
                .concat(encodeURIComponent(e)),
            );
          }
        };
        (0, o.useEffect)(() => {
          ie.length > 0 && localStorage.setItem("search", JSON.stringify(ie));
        }, [ie]);
        const ye = (e, t) => {
            le((s) => {
              let r;
              return (
                "add" === t
                  ? (r = s.includes(e) ? s : [...s, e])
                  : "remove" === t
                    ? (r = s.filter((t) => t !== e))
                    : "allRemove" === t &&
                      ((r = []), localStorage.removeItem("search")),
                r
              );
            });
          },
        ...
        const Ne = () => {
          (Y((0, y.a)("searchList")),
            ...
            fe((e) => (0, r.A)((0, r.A)({}, e), pe)));
        };
        return (0, I.jsxs)("div", {
          className: "h-full",
          children: [
            K && be.start && (0, I.jsx)(b.A, {}),
            (0, I.jsxs)("div", {
              className: "w-full bg-og text-white flex justify-between p-2",
              children: [
                (0, I.jsx)("div", {
                  ...
                  onClick: () => {
                    te.search && null === ae
                      ? z(-2)
                      : ae
                        ? (Ne(), sessionStorage.removeItem("searchQuery"))
                        : z(oe);
                  },
                  children: (0, I.jsx)(h.A, {
                    sx: { stroke: "white", strokeWidth: 2 },
                  }),
                }),
                (0, I.jsxs)("div", {
                  className: "flex flex-wrap items-start w-11/12 m-2 flex-col",
                  children: [
                    (0, I.jsxs)("div", {
                      ...
                      children: [
                        (0, I.jsx)("input", {
                          ...
                          type: "text",
                          className:
                            "w-full h-8 border-none outline-none rounded-sm text-gy px-8",
                        ...
                        (0, I.jsx)(u.A, {
                          className:
                            "absolute left-0 top-1/2 transform -translate-y-1/2 text-[#aaa] text-3xl",
                        }),
                        be.query &&
                          (0, I.jsx)(g.A, {
                    ...
                    (0, I.jsxs)("div", {
                      className: "flex",
                      onClick: () =>
                        ee((0, r.A)((0, r.A)({}, $), {}, { search: !0 })),
                      children: [
                        (0, I.jsx)(x.A, {}),
                        (0, I.jsx)("span", {
                          children: D("search.best_search_posture"),
                        }),
                      ],
                    }),
                  ],
            ...
            be.start &&
            (null === (F = U.list) || void 0 === F ? void 0 : F.length) > 0
              ? (0, I.jsxs)(d.u, {
                  completeDelay: 1e3,
                  refreshing: Z,
                  onRefresh: () => {
                  ...
                  children: [
                    (0, I.jsxs)("div", {
                      className: "bg-white w-full dark:bg-nbk",
                      children: [
                        (0, I.jsxs)("div", {
                          className: "h-10 flex items-center p-2 pt-5",
                          children: [
                            (0, I.jsxs)("p", {
                              children: [
                                D("search.search"),
                            ...
                            (0, I.jsxs)("button", {
                              className:
                                "ml-auto border-[1px] border-solid border-og py-1 px-1 rounded-md flex items-center dark:bg-nbk",
                              onClick: () =>
                                X(
                                  (0, r.A)((0, r.A)({}, V), {}, { search: !0 }),
                                ),
                              children: [
                                sessionStorage.getItem("searchSort") ||
                                  be.sort.title,
                                (0, I.jsx)(p.A, {}),
                              ],
                            }),
                    ...
                    (0, I.jsx)("button", {
                      ...
                      children: ge
                        ? (0, I.jsxs)("div", {
                            className: "flex items-center",
                            children: [
                              (0, I.jsx)(m.A, { color: "inherit", size: 12 }),
                              (0, I.jsx)("p", {
                                className: "ml-2",
                                children: D("comic.pull_to_load"),
                              }),
                            ],
                          })
                        : (0, I.jsx)("p", {
                            className: "text-center",
                            children: D("comic.no_more"),
                          }),
                    }),
                  ],
                })
              : (0, I.jsxs)("div", {
                  children: [
                    !K &&
                      ...
                      (0, I.jsx)("div", {
                        className:
                          "bg-white text-gy text-center py-5 dark:bg-nbk",
                        children: D("search.no_data_found"),
                      }),
                    (0, I.jsxs)("div", {
                      className: "bg-white mt-3 p-2 dark:bg-nbk",
                      children: [
                        (0, I.jsx)("p", {
                          className: "font-black",
                          children: D("search.popular_adult_topics"),
                        }),
                        (0, I.jsx)("div", {
                          ...
                          children:
                            ...
                            B.map((e, t) =>
                              (0, I.jsx)(
                                ...
                                {
                                  className:
                                    "border-[1px] border-solid border-gy rounded-md m-1 p-1",
                                  onClick: () => {
                                    (Ae(e),
                                      sessionStorage.setItem("searchQuery", e));
                                  },
                                  children: "#" + e,
                                },
                                t,
                    ...
                    ie.length > 0 &&
                      (0, I.jsxs)("div", {
                        ...
                        children: [
                          (0, I.jsx)("p", {
                            className: "font-black",
                            children: D("search.search_history"),
                          }),
                          (0, I.jsx)("div", {
                            className: "mt-3",
                            children: [...ie].reverse().map((e, t) =>
                              (0, I.jsxs)(
                                "div",
                                {
                                  className:
                                    "flex items-center px-1 border-b-[1px]",
                                  children: [
                                    (0, I.jsx)("p", {
                          ...
                          (0, I.jsx)("div", {
                            ...
                            children: (0, I.jsx)("p", {
                              ...
                              children: D("search.clear_search_history"),
                            }),
                          }),
                        ],
                      }),
                    (0, I.jsxs)("div", {
                      ...
                      children: [
                        (0, I.jsx)("p", {
                          className: "font-black",
                          children: D("search.random_recommendation"),
                        }),
                        (0, I.jsx)(j.A, {
                          t: D,
                          title: "search",
                        ...
                        (0, I.jsx)(a.N_, {
                          to: "/comic/detail?id=".concat(ne),
                          children: (0, I.jsx)("p", {
                            className:
                              "text-og text-center py-5 border-y-[1px] border-solid border-tgy",
                            children: D("search.random_recommendation"),
                          }),
                        }),
                      ],
                    }),
                    (0, I.jsx)(A.A, { adKey: "app_search_bottom_jm3" }),
                  ],
                }),
            (0, I.jsx)(f.A, {}),
            $.search &&
              (0, I.jsx)(v.A, { content: J, msgOpen: $, setMsgOpen: ee }),
            V.search &&
              (0, I.jsx)(k.A, {
                content: G,
                setDialogOpen: X,
            ...
            (0, I.jsx)(S.A, { snackbars: q, setSnackbars: R }),
          ],
        });
      };
    },
...
//# sourceMappingURL=5884.782e51ee.chunk.js.map
