  ...
  [4694],
  {
    8917: (t, e, n) => {
      ...
      function o() {
        ...
        const l = (0, i.useCallback)(() => t && o && o(a), [a, o, t]);
        return !n && o ? [!1, l] : [!0];
      }
    },
    2190: (t, e, n) => {
      n.d(e, { L: () => i });
      const i = (0, n(5043).createContext)({});
    },
    1051: (t, e, n) => {
      n.d(e, { Q: () => i });
      const i = (0, n(5043).createContext)({
    ...
    9674: (t, e, n) => {
      n.d(e, { t: () => i });
      const i = (0, n(5043).createContext)(null);
    },
    4694: (t, e, n) => {
      function i(t) {
      ...
      const h = c(() => void 0 !== window.ScrollTimeline);
      class d {
        constructor(t) {
      ...
      function v(t) {
        let e = 0;
        let n = t.next(e);
        for (; !n.done && e < f; ) ((e += 50), (n = t.next(e)));
        return e >= f ? 1 / 0 : e;
      }
      function g(t) {
      ...
      const x = (t) => Array.isArray(t) && "number" === typeof t[0],
        A = { linearEasing: void 0 };
      function F(t, e) {
        const n = c(t);
        return () => {
          var t;
          return null !== (t = A[e]) && void 0 !== t ? t : n();
        };
      }
      const P = F(() => {
          try {
        ...
        S = function (t, e) {
          ...
          for (let o = 0; o < s; o++) i += t(T(0, s - 1, o)) + ", ";
      ...
      function M(t, e) {
        ...
        return [
          n,
          (0, s.A)((0, s.A)({ passive: !0 }, e), {}, { signal: i.signal }),
          () => i.abort(),
        ];
      }
      function k(t) {
        return !("touch" === t.pointerType || V());
      }
      function R(t, e) {
        const n = "".concat(e, "PointerCapture");
        if (
      ...
      const B = (t, e) => !!e && (t === e || B(t, e.parentElement)),
        L = (t) =>
          "mouse" === t.pointerType
      ...
      function W(t, e) {
        ...
        const [i, s, o] = M(t, n),
          r = (t) => {
            ...
            if (!n || !N(t) || O.has(n)) return;
            (O.add(n), R(t, "set"));
            const i = e(n, t),
              o = (t, e) => {
                (n.removeEventListener("pointerup", r),
              ...
              r = (t) => {
                const e =
                  ...
                  i.clientX < s.left ||
                    ...
                    i.clientY > s.bottom);
                var i, s;
                o(t, !e && (!(n instanceof Element) || B(n, t.target)));
              },
              a = (t) => {
                o(t, !1);
              };
            (n.addEventListener("pointerup", r, s),
              n.addEventListener("pointercancel", a, s),
              n.addEventListener("lostpointercapture", a, s));
          };
        return (
          i.forEach((t) => {
            let e = !1;
            var i;
            ((t = n.useGlobalTarget ? window : t) instanceof HTMLElement &&
              ((e = !0),
              (i = t),
              j.has(i.tagName) ||
                -1 !== i.tabIndex ||
                ...
                (t.tabIndex = 0)),
              t.addEventListener("pointerdown", r, s),
              e &&
                t.addEventListener(
                  "focus",
                  (t) =>
                    ((t, e) => {
                      ...
                      const i = I(() => {
                        ...
                        (n.addEventListener("keyup", t, e),
                          n.addEventListener("blur", () => U(n, "cancel"), e));
                      });
      ...
      function J(t, e) {
        ...
        const s = { delta: 0, timestamp: 0, isProcessing: !1 },
          ...
          p = () => {
            const o = Z ? s.timestamp : performance.now();
            ((n = !1),
              Z ||
                (s.delta = i
                  ? 1e3 / 60
        ...
        return {
          schedule: m,
          cancel: (t) => {
            for (let e = 0; e < $.length; e++) r[$[e]].cancel(t);
          },
          state: s,
          steps: r,
        };
      ...
      const rt = {
        now: () => (
          void 0 === st &&
            rt.set(nt.isProcessing || Z ? nt.timestamp : performance.now()),
          st
        ),
        set: (t) => {
          ((st = t), queueMicrotask(ot));
        },
      };
      function at(t, e) {
      ...
      class ut {
        ...
        add(t) {
          return (at(this.subscriptions, t), () => lt(this.subscriptions, t));
        }
        notify(t, e, n) {
      ...
      class dt {
          ...
          ((this.version = "12.4.7"),
            ...
            (this.updateAndNotify = function (t) {
              ...
              (e.updatedAt !== i && e.setPrevFrameValue(),
                ...
                e.current !== e.prev &&
                  e.events.change &&
                  e.events.change.notify(e.current),
                n &&
                  e.events.renderRequest &&
                  e.events.renderRequest.notify(e.current));
            }),
            (this.hasAnimated = !1),
            this.setCurrent(t),
            (this.owner = n.owner));
        ...
        on(t, e) {
          this.events[t] || (this.events[t] = new ut());
      ...
      const mt = ["transitionEnd", "transition"];
      function ft(t, e, n) {
      ...
      function gt(t, e) {
        ...
        if (((i = n), Boolean(vt(i) && i.add))) return n.add(e);
        var i;
      }
      const yt = (t) => t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(),
        xt = "data-" + yt("framerAppearId");
      function At(t) {
        return t.props[xt];
      }
      const Ft = !1,
      ...
      function Tt(t, e, n, i) {
        ...
        return (t) => (0 === t || 1 === t ? t : Pt(s(t), e, i));
      }
      const St = (t) => (e) =>
          e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
        Dt = (t) => (e) => 1 - t(1 - e),
        wt = Tt(0.33, 1.53, 0.69, 0.99),
        bt = Dt(wt),
        Et = St(bt),
        Ct = (t) =>
          (t *= 2) < 1 ? 0.5 * bt(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
        Vt = (t) => 1 - Math.sin(Math.acos(t)),
        Mt = Dt(Vt),
        kt = St(Vt),
        Rt = (t) =>
      ...
      const Bt = (t, e, n) => (n > e ? e : n < t ? t : n),
        ...
        jt = (0, s.A)((0, s.A)({}, Lt), {}, { transform: (t) => Bt(0, 1, t) }),
        Ot = (0, s.A)((0, s.A)({}, Lt), {}, { default: 1 }),
      ...
      const Nt =
        ...
        Wt = (t, e) => (n) =>
          Boolean(
            ("string" === typeof n && Nt.test(n) && n.startsWith(t)) ||
            (e &&
              !(function (t) {
                return null == t;
              })(n) &&
        ...
        Yt = (0, s.A)(
          (0, s.A)({}, Lt),
          {},
          { transform: (t) => Math.round(((t) => Bt(0, 255, t))(t)) },
        ),
        Kt = {
          test: Wt("rgb", "red"),
          parse: zt("red", "green", "blue"),
          transform: (t) => {
            let { red: e, green: n, blue: i, alpha: s = 1 } = t;
            return (
              "rgba(" +
              Yt.transform(e) +
              ", " +
      ...
      const Xt = {
        ...
        Qt = (0, s.A)(
          ...
          {},
          {
            ...
            transform: (t) => qt.transform(100 * t),
          },
        ),
        Jt = {
          test: Wt("hsl", "hue"),
          ...
          transform: (t) => {
            let { hue: e, saturation: n, lightness: i, alpha: s = 1 } = t;
            return (
              "hsla(" +
              Math.round(e) +
              ", " +
        ...
        te = {
          test: (t) => Kt.test(t) || Xt.test(t) || Jt.test(t),
          parse: (t) =>
            Kt.test(t) ? Kt.parse(t) : Jt.test(t) ? Jt.parse(t) : Xt.parse(t),
          transform: (t) =>
            "string" === typeof t
              ? t
      ...
      function oe(t) {
        ...
        const r = e
          .replace(
            ...
            (t) => (
              te.test(t)
                ? (i.color.push(o), s.push(ie), n.push(te.parse(t)))
                : t.startsWith("var(")
                  ? (i.var.push(o), s.push("var"), n.push(t))
                  : (i.number.push(o), s.push(ne), n.push(parseFloat(t))),
              ++o,
              "${}"
            ),
          )
      ...
      function ae(t) {
        ...
        return (t) => {
          ...
          for (let o = 0; o < i; o++)
            if (((s += e[o]), void 0 !== t[o])) {
              const e = n[o];
              s += e === ne ? It(t[o]) : e === ie ? te.transform(t[o]) : t[o];
            }
          return s;
        };
      }
      const le = (t) => ("number" === typeof t ? 0 : t);
      const ue = {
          test: function (t) {
            var e, n;
            return (
              isNaN(t) &&
              "string" === typeof t &&
              ((null === (e = t.match(Ut)) || void 0 === e
                ? void 0
                : e.length) || 0) +
                ((null === (n = t.match(ee)) || void 0 === n
                  ? void 0
                  : n.length) || 0) >
                0
            );
          ...
          parse: re,
          createTransformer: ae,
          getAnimatableNone: function (t) {
            const e = re(t);
            return ae(t)(e.map(le));
          },
        },
        ce = new Set(["brightness", "contrast", "saturate", "opacity"]);
      function he(t) {
      ...
      const de =
        ...
        ve = (0, s.A)((0, s.A)({}, Lt), {}, { transform: Math.round }),
        ge = (0, s.A)(
          (0, s.A)((0, s.A)({}, me), fe),
          {},
          {
      ...
      const Pe = (t) => t === Lt || t === _t,
        Te = (t, e) => parseFloat(t.split(", ")[e]),
        Se = (t, e) => (n, i) => {
          let { transform: s } = i;
        ...
        De = new Set(["x", "y", "z"]),
        we = X.filter((t) => !De.has(t));
      const be = {
        width: (t, e) => {
          let { x: n } = t,
            { paddingLeft: i = "0", paddingRight: s = "0" } = e;
          return n.max - n.min - parseFloat(i) - parseFloat(s);
        },
        height: (t, e) => {
          let { y: n } = t,
            { paddingTop: i = "0", paddingBottom: s = "0" } = e;
          return n.max - n.min - parseFloat(i) - parseFloat(s);
        },
        top: (t, e) => {
          let { top: n } = e;
      ...
      ((be.translateX = be.x), (be.translateY = be.y));
      const Ee = new Set();
      let Ce = !1,
        Ve = !1;
      function Me() {
        if (Ve) {
          const t = Array.from(Ee).filter((t) => t.needsMeasurement),
            ...
            e.forEach((t) => {
              ...
              e &&
                e.forEach((e) => {
                  let [n, i] = e;
                  var s;
                  null === (s = t.getValue(n)) || void 0 === s || s.set(i);
                });
            }),
        ...
        ((Ve = !1), (Ce = !1), Ee.forEach((t) => t.complete()), Ee.clear());
      }
      function ke() {
        Ee.forEach((t) => {
      ...
      class Re {
        ...
        scheduleResolve() {
          ((this.isScheduled = !0),
            this.isAsync
              ? (Ee.add(this),
                Ce || ((Ce = !0), tt.read(ke), tt.resolveKeyframes(Me)))
        ...
        readKeyframes() {
          ...
          for (let s = 0; s < t.length; s++)
            if (null === t[s])
              if (0 === s) {
                const s = null === i || void 0 === i ? void 0 : i.get(),
                  o = t[t.length - 1];
                if (void 0 !== s) t[0] = s;
                else if (n && e) {
        ...
        cancel() {
          this.isComplete || ((this.isScheduled = !1), Ee.delete(this));
        }
        resume() {
      ...
      let Be = K,
        Le = K;
      const je = (t) => /^-?(?:[0-9]+(?:\.[0-9]+)?|\.[0-9]+)$/.test(t),
        Oe = (t) => (e) => "string" === typeof e && e.startsWith(t),
        Ie = Oe("--"),
        Ue = Oe("var(--"),
        Ne = (t) => !!Ue(t) && We.test(t.split("/*")[0].trim()),
        We =
      ...
      function Ye(t, e) {
        ...
        const [i, s] = (function (t) {
          ...
          if (!e) return [,];
          const [, n, i, s] = e;
          return ["--".concat(null !== n && void 0 !== n ? n : i), s];
        })(t);
        if (!i) return;
        ...
        return Ne(s) ? Ye(s, e, n + 1) : s;
      }
      const Ke = (t) => (e) => e.test(t),
        Xe = [
          Lt,
          _t,
          qt,
      ...
      class Ge extends Re {
        ...
        readKeyframes() {
          ...
          for (let a = 0; a < t.length; a++) {
            let n = t[a];
            if ("string" === typeof n && ((n = n.trim()), Ne(n))) {
              const i = Ye(n, e.current);
              (void 0 !== i && (t[a] = i),
                a === t.length - 1 && (this.finalKeyframe = n));
            }
          }
          if ((this.resolveNoneKeyframes(), !G.has(n) || 2 !== t.length))
            return;
          const [i, s] = t,
            o = He(i),
            r = He(s);
        ...
        resolveNoneKeyframes() {
          ...
          for (let s = 0; s < t.length; s++)
            ("number" === typeof (i = t[s])
              ? 0 === i
              : null === i || "none" === i || "0" === i || Rt(i)) && n.push(s);
          var i;
          n.length &&
            (function (t, e, n) {
              let i,
              ...
              if (i && n) for (const o of e) t[o] = Ae(n, i);
            })(t, n, e);
        }
        measureInitialState() {
      ...
      const Ze = (t) => null !== t;
      function $e(t, e, n) {
        let { repeat: i, repeatType: s = "loop" } = e;
        const o = t.filter(Ze),
          r = i && "loop" !== s && i % 2 === 1 ? 0 : o.length - 1;
      ...
      class Je {
        ...
        get resolved() {
          return (
            this._resolved || this.hasAttemptedResolve || (ke(), Me()),
            this._resolved
          );
        }
        onKeyframesResolved(t, e) {
          ...
          !1 !== c &&
            ((this._resolved = (0, s.A)({ keyframes: t, finalKeyframe: e }, c)),
            this.onPostResolved());
        }
        onPostResolved() {}
        then(t, e) {
      ...
      const tn = { layout: 0, mainThread: 0, waapi: 0 },
        en = (t, e, n) => t + (e - t) * n;
      function nn(t, e, n) {
        return (
          n < 0 && (n += 1),
      ...
      function an(t) {
        ...
        return (
          e === Jt &&
            (i = (function (t) {
              let { hue: e, saturation: n, lightness: i, alpha: s } = t;
              ((e /= 360), (n /= 100), (i /= 100));
              let o = 0,
                r = 0,
                a = 0;
      ...
      const ln = (t, e) => {
          const n = an(t),
            i = an(e);
          if (!n || !i) return sn(t, e);
          const o = (0, s.A)({}, n);
          return (t) => (
            (o.red = on(n.red, i.red, t)),
            (o.green = on(n.green, i.green, t)),
            (o.blue = on(n.blue, i.blue, t)),
            (o.alpha = en(n.alpha, i.alpha, t)),
            Kt.transform(o)
          );
        },
        un = (t, e) => (n) => e(t(n)),
      ...
      function fn(t, e) {
        const n = (0, s.A)((0, s.A)({}, t), e),
          i = {};
        for (const s in n)
          void 0 !== t[s] && void 0 !== e[s] && (i[s] = pn(t[s])(t[s], e[s]));
        return (t) => {
      ...
      const vn = (t, e) => {
        const n = ue.createTransformer(e),
          i = oe(t),
          s = oe(e);
        return i.indexes.var.length === s.indexes.var.length &&
          ...
          ? (hn.has(t) && !s.values.length) || (hn.has(e) && !i.values.length)
            ? (function (t, e) {
                return hn.has(t)
                  ? (n) => (n <= 0 ? t : e)
                  : (n) => (n >= 1 ? e : t);
      ...
      function Fn(t) {
        ...
        let a = 1 - s;
        ((a = Bt(xn.minDamping, xn.maxDamping, a)),
          (i = Bt(xn.minDuration, xn.maxDuration, Y(i))),
          a < 1
            ? ((e = (t) => {
                const e = t * a,
                  n = e * i,
      ...
      function bn() {
        ...
        const r = n.keyframes[0],
          ...
          l = { done: !1, value: r },
          {
            ...
            if (!wn(t, Dn) && wn(t, Sn))
              if (t.visualDuration) {
                const n = t.visualDuration,
                  i = (2 * Math.PI) / (1.2 * n),
                  o = i * i,
                  r = 2 * Bt(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(o);
                e = (0, s.A)(
                  (0, s.A)({}, e),
                  {},
                  { mass: xn.mass, stiffness: o, damping: r },
                );
              } else {
                const n = Fn(t);
                ((e = (0, s.A)(
            ...
            return e;
          })((0, s.A)((0, s.A)({}, n), {}, { velocity: -Y(n.velocity || 0) })),
          g = p || 0,
          y = c / (2 * Math.sqrt(u * h)),
          x = a - r,
          A = Y(Math.sqrt(u / h)),
        ...
        let P;
        if (
          (i || (i = F ? xn.restSpeed.granular : xn.restSpeed.default),
          o || (o = F ? xn.restDelta.granular : xn.restDelta.default),
          y < 1)
        ) {
          const t = Tn(A, y);
          P = (e) => {
            const n = Math.exp(-y * A * e);
            return (
              a -
              n *
                (((g + y * A * x) / t) * Math.sin(t * e) + x * Math.cos(t * e))
            );
          };
        } else if (1 === y)
          P = (t) => a - Math.exp(-A * t) * (x + (g + A * x) * t);
        else {
          const t = A * Math.sqrt(y * y - 1);
          P = (e) => {
            const n = Math.exp(-y * A * e),
              i = Math.min(t * e, 300);
            return (
              a -
              (n * ((g + y * A * x) * Math.sinh(i) + t * x * Math.cosh(i))) / t
            );
          };
        }
        const T = {
          ...
          toString: () => {
            const t = Math.min(v(T), f),
              e = S((e) => T.next(t * e).value, t, 30);
            return t + "ms " + e;
          },
        };
        return T;
      ...
      function En(t) {
        ...
        const T = (t) => {
          var e;
          ((e = p.value), (void 0 !== l && e < l) || (void 0 !== u && e > u)) &&
            ((F = t),
            (P = bn({
              keyframes: [p.value, m(p.value)],
              velocity: yn(x, t, p.value),
              damping: o,
              stiffness: r,
              restDelta: c,
              restSpeed: h,
        ...
        return (
          T(0),
          {
            ...
            next: (t) => {
              let e = !1;
              return (
                P || void 0 !== F || ((e = !0), A(t), T(t)),
                void 0 !== F && t >= F ? P.next(t - F) : (!e && A(t), p)
              );
            },
          }
        );
      }
      const Cn = Tt(0.42, 0, 1, 1),
        Vn = Tt(0, 0, 0.58, 1),
        Mn = Tt(0.42, 0, 0.58, 1),
        kn = {
          linear: K,
        ...
        Rn = (t) => {
          ...
          return "string" === typeof t
            ? (Le(void 0 !== kn[t], "Invalid easing type '".concat(t, "'")),
              kn[t])
            : t;
        };
      function Bn(t, e) {
        ...
        const a = (function (t, e, n) {
            ...
            for (let r = 0; r < o; r++) {
              let n = s(t[r], t[r + 1]);
              if (e) {
                const t = Array.isArray(e) ? e[r] || K : e;
                n = cn(t, n);
              }
              i.push(n);
            }
          ...
          u = (n) => {
            ...
            const s = T(t[i], t[i + 1], n);
            return a[i](s);
          };
        return n ? (e) => u(Bt(t[0], t[o - 1], e)) : u;
      }
      function Ln(t) {
        const e = [0];
        return (
      ...
      function jn(t) {
        ...
        const o = ((t) => Array.isArray(t) && "number" !== typeof t[0])(s)
            ? s.map(Rn)
            : Rn(s),
          r = { done: !1, value: n[0] },
          a = (function (t, e) {
            return t.map((t) => t * e);
          })(i && i.length === n.length ? i : Ln(n), e),
          l = Bn(a, n, {
            ease: Array.isArray(o)
              ? o
              : ((u = n),
                (c = o),
                u.map(() => c || Mn).splice(0, u.length - 1)),
          });
        var u, c;
        return {
      ...
      const On = (t) => {
          ...
          return {
            start: () => tt.update(e, !0),
            stop: () => et(e),
            now: () => (nt.isProcessing ? nt.timestamp : rt.now()),
          };
        },
        In = { decay: En, inertia: En, tween: jn, keyframes: jn, spring: bn },
        Un = (t) => t / 100;
      class Nn extends Je {
        constructor(t) {
          (super(t),
          ...
          const {
            ...
            o =
              (null === i || void 0 === i ? void 0 : i.KeyframeResolver) || Re;
          ((this.resolver = new o(
            s,
        ...
        initPlayback(t) {
          ...
          a !== jn &&
            "number" !== typeof t[0] &&
            ((l = cn(Un, gn(t[0], t[1]))), (t = [0, 100]));
          const c = a(
            (0, s.A)((0, s.A)({}, this.options), {}, { keyframes: t }),
          );
          ("mirror" === o &&
            (u = a(
              (0, s.A)(
                (0, s.A)({}, this.options),
                {},
                { keyframes: [...t].reverse(), velocity: -r },
              ),
            )),
        ...
        tick(t) {
          ...
          const A = g ? { done: !1, value: a[0] } : x.next(y);
          r && (A.value = r(A.value));
          let { done: F } = A;
          g ||
            null === l ||
          ...
          const P =
            null === this.holdTime &&
            ("finished" === this.state || ("running" === this.state && F));
          return (
            P && void 0 !== i && (A.value = $e(a, this.options, i)),
            f && f(A.value),
            P && this.finish(),
            A
          );
        ...
        play() {
          ...
          const { driver: t = On, onPlay: e, startTime: n } = this.options;
      ...
      const zn = c(() =>
        ...
        Yn = ["onComplete", "onUpdate", "motionValue", "element"],
        Kn = ["motionValue", "onUpdate", "onComplete", "element"];
      const Xn = { anticipate: Ct, backInOut: Et, circInOut: kt };
      class Hn extends Je {
        constructor(t) {
          super(t);
          const {
        ...
        initPlayback(t, e) {
          ...
          var h;
          if (
            ("string" === typeof o && P() && o in Xn && (o = Xn[o]),
            g((h = this.options).type) || "spring" === h.type || !D(h.ease))
          ) {
            const e = this.options,
              { onComplete: l, onUpdate: u, motionValue: c, element: h } = e,
              d = (0, r.A)(e, Yn),
              p = (function (t, e) {
                const n = new Nn(
                  (0, s.A)(
                    (0, s.A)({}, e),
                    {},
                    { keyframes: t, repeat: 0, delay: 0, isGenerator: !0 },
                  ),
                );
                ...
                let r = 0;
                for (; !i.done && r < 2e4; )
                  ((i = n.sample(r)), o.push(i.value), (r += 10));
                return {
                  times: void 0,
                  keyframes: o,
                  duration: r - 10,
            ...
            (1 === (t = p.keyframes).length && (t[1] = t[0]),
              (n = p.duration),
              (i = p.times),
              (o = p.ease),
              (a = "keyframes"));
          ...
          const d = (function (t, e, n) {
            ...
            l && (u.offset = l);
            const c = E(a, s);
            (Array.isArray(c) && (u.easing = c), Q.value && tn.waapi++);
            const h = t.animate(u, {
              delay: i,
              duration: s,
            ...
            (0, s.A)(
              (0, s.A)({}, this.options),
              {},
              { duration: n, times: i, ease: o },
            ),
          );
          return (
            (d.startTime =
              null !== c && void 0 !== c ? c : this.calcStartTime()),
            this.pendingTimeline
              ? (y(d, this.pendingTimeline), (this.pendingTimeline = void 0))
              : (d.onfinish = () => {
        ...
        stop() {
          ...
          if (this.time) {
            const t = this.options,
              { motionValue: e, onUpdate: u, onComplete: c, element: h } = t,
              d = (0, r.A)(t, Kn),
              p = new Nn(
                (0, s.A)(
                  (0, s.A)({}, d),
              ...
              m = z(this.time);
            e.setWithVelocity(p.sample(m - 10).value, p.sample(m).value, 10);
          }
      ...
      const Gn = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        qn = { type: "keyframes", duration: 0.8 },
        _n = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
        Zn = (t, e) => {
          let { keyframes: n } = e;
          return n.length > 2
            ? qn
      ...
      const Qn = function (t, e, n) {
          ...
          return (l) => {
            ...
            })(u) || (d = (0, s.A)((0, s.A)({}, d), Zn(t, d))),
              d.duration && (d.duration = z(d.duration)),
              d.repeatDelay && (d.repeatDelay = z(d.repeatDelay)),
              void 0 !== d.from && (d.keyframes[0] = d.from));
            let f = !1;
            if (
              ((!1 === d.type || (0 === d.duration && !d.repeatDelay)) &&
                ((d.duration = 0), 0 === d.delay && (f = !0)),
              (Ft || _) && ((f = !0), (d.duration = 0), (d.delay = 0)),
              f && !a && void 0 !== e.get())
            ) {
              const t = $e(d.keyframes, u);
              if (void 0 !== t)
                return (
                  tt.update(() => {
            ...
            return !a && Hn.supports(d) ? new Hn(d) : new Nn(d);
          };
        },
        Jn = ["transition", "transitionEnd"];
      function ti(t, e) {
        let { protectedKeys: n, needsAnimating: i } = t;
        const s = n.hasOwnProperty(e) && !0 !== i[e];
        return ((i[e] = !1), s);
      }
      function ei(t, e) {
        let {
        ...
        var a;
        let { transition: l = t.getDefaultTransition(), transitionEnd: c } = e,
          h = (0, r.A)(e, Jn);
        i && (l = i);
        const d = [],
          p = o && t.animationState && t.animationState.getState()[o];
        for (const r in h) {
          const e = t.getValue(
              r,
              null !== (a = t.latestValues[r]) && void 0 !== a ? a : null,
            ),
            i = h[r];
          if (void 0 === i || (p && ti(p, r))) continue;
          const o = (0, s.A)({ delay: n }, m(l || {}, r));
          let u = !1;
          if (window.MotionHandoffAnimation) {
            const e = At(t);
            if (e) {
              const t = window.MotionHandoffAnimation(e, r, tt);
          ...
          (gt(t, r),
            e.start(
              Qn(
                ...
                e,
                i,
                t.shouldReduceMotion && G.has(r) ? { type: !1 } : o,
                t,
                u,
              ),
            ));
            ...
            Promise.all(d).then(() => {
              tt.update(() => {
                c &&
                  (function (t, e) {
                    let n = u(t, e) || {},
                      { transitionEnd: i = {}, transition: o = {} } = n,
                      a = (0, r.A)(n, mt);
                    a = (0, s.A)((0, s.A)({}, a), i);
                    for (const s in a)
                      ft(t, s, ((l = a[s]), q(l) ? l[l.length - 1] || 0 : l));
                    var l;
                  })(t, c);
              });
            }),
      ...
      function ni(t, e) {
        ...
        const a = o ? () => Promise.all(ei(t, o, n)) : () => Promise.resolve(),
          l =
          ...
          { when: c } = r;
        if (c) {
          const [t, e] = "beforeChildren" === c ? [a, l] : [l, a];
          return t().then(() => e());
        }
      ...
      function ui(t) {
        ...
        if (!t.isControllingVariants) {
          const e = (t.parent && ui(t.parent)) || {};
          return (
            void 0 !== t.props.initial && (e.initial = t.props.initial),
            e
          );
        }
        const e = {};
      ...
      const ci = ["transition", "transitionEnd"],
        hi = [...ri].reverse(),
        di = ri.length;
      function pi(t) {
        return (e) =>
            ...
            e.map((e) => {
              ...
              return (function (t, e) {
                ...
                if ((t.notify("AnimationStart", e), Array.isArray(e))) {
                  const s = e.map((e) => ni(t, e, i));
                  n = Promise.all(s);
                } else if ("string" === typeof e) n = ni(t, e, i);
                else {
                  const s = "function" === typeof e ? u(t, e, i.custom) : e;
                  n = Promise.all(ei(t, s, i));
                }
                return n.then(() => {
      ...
      function mi(t) {
        ...
        const a = (e) => (n, i) => {
          ...
          const a = u(
            ...
            i,
            "exit" === e
              ? null === (o = t.presenceContext) || void 0 === o
                ? void 0
                : o.custom
              : void 0,
          );
          if (a) {
            const { transition: t, transitionEnd: e } = a,
              i = (0, r.A)(a, ci);
            n = (0, s.A)((0, s.A)((0, s.A)({}, n), i), e);
          }
          return n;
        };
        function l(r) {
          ...
          for (let e = 0; e < di; e++) {
            const u = hi[e],
              ...
              g = oi(v),
              y = u === r ? f.isActive : null;
            !1 === y && (m = e);
            let x = v === c[u] && v !== l[u] && g;
            if (
              (x && i && t.manuallyAnimateOnMount && (x = !1),
              (f.protectedKeys = (0, s.A)({}, p)),
              (!f.isActive && null === y) ||
                (!v && !f.prevProp) ||
                o(v) ||
                "boolean" === typeof v)
              ...
              continue;
            const A = fi(f.prevProp, v);
            let F = A || (u === r && f.isActive && !x && g) || (e > m && g),
              P = !1;
            const T = Array.isArray(v) ? v : [v];
            let S = T.reduce(a(u), {});
            !1 === y && (S = {});
            const { prevResolvedValues: D = {} } = f,
              w = (0, s.A)((0, s.A)({}, D), S),
              b = (e) => {
                ((F = !0),
            ...
            ((f.prevProp = v),
              ...
              f.isActive && (p = (0, s.A)((0, s.A)({}, p), S)),
              i && t.blockInitialAnimation && (F = !1));
            F &&
              (!(x && A) || P) &&
              h.push(...T.map((t) => ({ animation: t, options: { type: u } })));
          }
          if (d.size) {
            const e = {};
      ...
      function Si(t) {
        let { top: e, left: n, right: i, bottom: s } = t;
      ...
      function bi(t, e, n, i) {
        (wi(t.x, e.x, n.x, i ? i.originX : void 0),
          wi(t.y, e.y, n.y, i ? i.originY : void 0));
      }
      function Ei(t, e, n) {
        ((t.min = n.min + e.min), (t.max = t.min + Di(e)));
      }
      function Ci(t, e, n) {
        ((t.min = e.min - n.min), (t.max = t.min + Di(e)));
      }
      function Vi(t, e, n) {
        (Ci(t.x, e.x, n.x), Ci(t.y, e.y, n.y));
      }
      const Mi = () => ({ x: { min: 0, max: 0 }, y: { min: 0, max: 0 } });
      function ki(t) {
        return [t("x"), t("y")];
      }
      function Ri(t) {
      ...
      function Ui(t, e, n, i, s) {
        return (void 0 !== s && (t = Ii(t, s, i)), Ii(t, n, i) + e);
      }
      function Ni(t) {
        let e =
      ...
      function Wi(t, e) {
        ...
        (Ni(t.x, n.translate, n.scale, n.originPoint),
          Ni(t.y, i.translate, i.scale, i.originPoint));
      }
      const zi = 0.999999999999,
        Yi = 1.0000000000001;
      function Ki(t, e) {
      ...
      const _i = (t, e) => Math.abs(t - e);
      class Zi {
        constructor(t, e) {
          let { transformPagePoint: n, dragSnapToOrigin: i = !1 } =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
          if (
            ...
            (this.updatePoint = () => {
              ...
              const { point: i } = t,
                { timestamp: o } = nt;
              this.history.push(
                (0, s.A)((0, s.A)({}, i), {}, { timestamp: o }),
              );
              const { onStart: r, onMove: a } = this.handlers;
              (e ||
          ...
          const o = $i(Pi(t), this.transformPagePoint),
            { point: r } = o,
            { timestamp: a } = nt;
          this.history = [(0, s.A)((0, s.A)({}, r), {}, { timestamp: a })];
          const { onSessionStart: l } = e;
          (l && l(t, Ji(o, this.history)),
            R(t, "set"),
            (this.removeListeners = cn(
              Ti(t.currentTarget, "pointermove", this.handlePointerMove),
              Ti(t.currentTarget, "pointerup", this.handlePointerUp),
              Ti(t.currentTarget, "pointercancel", this.handlePointerUp),
              Ti(t.currentTarget, "lostpointercapture", this.handlePointerUp),
            )));
        }
        updateHandlers(t) {
          this.handlers = t;
      ...
      function ns(t, e) {
        ...
        let n = t.length - 1,
          i = null;
        const s = es(t);
        for (; n >= 0 && ((i = t[n]), !(s.timestamp - i.timestamp > z(e))); )
          n--;
        if (!i) return { x: 0, y: 0 };
      ...
      class us {
            ...
            t,
            {
              onSessionStart: (t) => {
                ...
                (n ? this.pauseAnimation() : this.stopAnimation(),
                  e && this.snapToCursor(Pi(t).point));
              },
              onStart: (t, e) => {
                const {
                  drag: n,
                  ...
                  ki((t) => {
                    ...
                    if (qt.test(e)) {
                      ...
                      if (n && n.layout) {
                        ...
                        if (i) {
                          e = Di(i) * (parseFloat(e) / 100);
                        }
                      }
                    }
                    this.originPoint[t] = e;
                  }),
                  s && tt.postRender(() => s(t, e)),
                  gt(this.visualElement, "transform"));
        ...
        updateAxis(t, e, n) {
          ...
          if (!n || !cs(t, i, this.currentDirection)) return;
          ...
          (this.constraints &&
            ...
            (o = (function (t, e, n) {
              ...
              return (
                void 0 !== i && t < i
                  ? (t = n ? en(i, t, n.min) : Math.max(t, i))
                  : void 0 !== s &&
                    t > s &&
                    (t = n ? en(s, t, n.max) : Math.min(t, s)),
                t
              );
        ...
        resolveConstraints() {
          ...
          (e && qi(e)
            ...
            : (this.constraints =
                !(!e || !i) &&
                (function (t, e) {
                  let { top: n, left: i, bottom: s, right: o } = e;
                  return { x: is(t.x, i, o), y: is(t.y, n, s) };
                })(i.layoutBox, e)),
        ...
        resolveRefConstraints() {
          ...
          const s = (function (t, e, n) {
            const i = Gi(t, n),
              { scroll: s } = e;
            return (s && (Ki(i.x, s.offset.x), Ki(i.y, s.offset.y)), i);
          ...
          if (e) {
            ...
            ((this.hasMutatedConstraints = !!t), t && (o = Si(t)));
          }
          return o;
        }
        startAnimation(t) {
          const {
            ...
            l = this.constraints || {},
            u = ki((a) => {
              if (!cs(a, e, this.currentDirection)) return;
              let u = (l && l[a]) || {};
              r && (u = { min: 0, max: 0 });
              const c = i ? 200 : 1e6,
                h = i ? 40 : 1e7,
        ...
        startAxisValueAnimation(t, e) {
          ...
          return (
            gt(this.visualElement, t),
            n.start(Qn(t, n, 0, e, this.visualElement, !1))
          );
        }
        stopAnimation() {
          ki((t) => this.getAxisMotionValue(t).stop());
        }
        pauseAnimation() {
          ki((t) => {
            var e;
        ...
        scalePositionWithinConstraints() {
          ...
          if (!qi(e) || !n || !this.constraints) return;
          this.stopAnimation();
          const i = { x: 0, y: 0 };
          ki((t) => {
            ...
            if (e && !1 !== this.constraints) {
              ...
              i[t] = (function (t, e) {
                ...
                return (
                  s > i
                    ? (n = T(e.min, e.max - i, t.min))
                    : i > s && (n = T(t.min, t.max - s, e.min)),
                  Bt(0, 1, n)
                );
        ...
        addListeners() {
          ...
          const t = Ti(this.visualElement.current, "pointerdown", (t) => {
      ...
      var ds = n(579),
        ...
        ms = n(8917),
        fs = n(2190);
      const vs = (0, ps.createContext)({}),
        gs = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      function ys(t, e) {
      ...
      const xs = {
          correct: (t, e) => {
            ...
            if ("string" === typeof t) {
              if (!_t.test(t)) return t;
              t = parseFloat(t);
            }
            const n = ys(t, e.target.x),
              i = ys(t, e.target.y);
        ...
        As = {
          correct: (t, e) => {
            ...
            const r = ue.createTransformer(t),
        ...
        Fs = {};
      const { schedule: Ps, cancel: Ts } = J(queueMicrotask, !1);
      class Ss extends ps.Component {
        componentDidMount() {
          const {
              visualElement: t,
              layoutGroup: e,
          ...
          (!(function (t) {
            for (const e in t)
              ((Fs[e] = t[e]), Ie(e) && (Fs[e].isCSSVariable = !0));
          })(ws),
            o &&
      ...
      function Ds(t) {
        ...
        return (0, ds.jsx)(
          ...
          (0, s.A)(
            ...
            {
              layoutGroup: i,
              switchLayoutGroup: (0, ps.useContext)(vs),
              isPresent: e,
              safeToRemove: n,
            },
          ),
      ...
      class Es {
        ...
        add(t) {
          (at(this.children, t), (this.isDirty = !0));
        }
        remove(t) {
          (lt(this.children, t), (this.isDirty = !0));
        }
        forEach(t) {
      ...
      const Ms = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        ks = Ms.length,
        Rs = (t) => ("string" === typeof t ? parseFloat(t) : t),
        Bs = (t) => "number" === typeof t || _t.test(t);
      function Ls(t, e) {
        return void 0 !== t[e] ? t[e] : t.borderRadius;
      }
      const js = Is(0, 0.5, Mt),
        Os = Is(0.5, 0.95, K);
      function Is(t, e, n) {
        return (i) => (i < t ? 0 : i > e ? 1 : n(T(t, e, i)));
      }
      function Us(t, e) {
          ...
          let e =
            ...
            r =
              arguments.length > 6 && void 0 !== arguments[6]
                ...
                : t;
          qt.test(e) &&
            ((e = parseFloat(e)), (e = en(r.min, r.max, e / 100) - r.min));
          if ("number" !== typeof e) return;
          let a = en(o.min, o.max, i);
          (t === o && (a -= e),
            (t.min = zs(t.min, e, n, a, s)),
            (t.max = zs(t.max, e, n, a, s)));
        })(t, e[o], e[r], e[a], e.scale, i, s);
      }
      const Ks = ["x", "scaleX", "originX"],
        Xs = ["y", "scaleY", "originY"];
      function Hs(t, e, n, i) {
        (Ys(t.x, e, Ks, n ? n.x : void 0, i ? i.x : void 0),
          Ys(t.y, e, Xs, n ? n.y : void 0, i ? i.y : void 0));
      }
      function Gs(t) {
      ...
      class to {
        ...
        add(t) {
          (at(this.members, t), t.scheduleRender());
        }
        remove(t) {
          if (
            (lt(this.members, t),
      ...
      function ro(t) {
        ...
        if (window.MotionHasOptimisedAnimation(n, "transform")) {
          ...
          window.MotionCancelOptimisedAnimation(n, "transform", tt, !(e || i));
        }
        const { parent: i } = t;
      ...
      function ao(t) {
        ...
        return class {
            ...
            ((this.id = so++),
              ...
              (this.updateProjection = () => {
                ((this.projectionUpdateScheduled = !1),
                  Q.value &&
                    (eo.nodes =
                      eo.calculatedTargetDeltas =
                      eo.calculatedProjections =
                        0),
                  this.nodes.forEach(co),
                  this.nodes.forEach(yo),
                  this.nodes.forEach(xo),
                  this.nodes.forEach(ho),
                  Q.addProjectionMetrics && Q.addProjectionMetrics(eo));
              }),
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new ut()),
          ...
          mount(t) {
            ...
            var i;
            ((this.isSVG =
              (i = t) instanceof SVGElement && "svg" !== i.tagName),
              (this.instance = t));
            const { layoutId: o, layout: r, visualElement: a } = this.options;
            if (
              ...
              e(t, () => {
                ((this.root.updateBlockedByResize = !0),
                  ...
                  gs.hasAnimatedSinceResize &&
                    ((gs.hasAnimatedSinceResize = !1), this.nodes.forEach(go)));
              });
            }
            (o && this.root.registerSharedNode(o, this),
              !1 !== this.options.animate &&
                ...
                this.addEventListener("didUpdate", (t) => {
                  ...
                  const r =
                      this.options.transition || a.getDefaultTransition() || Do,
                    {
                      onLayoutAnimationStart: l,
                      onLayoutAnimationComplete: u,
                    } = a.getProps(),
                    c = !this.targetLayout || !$s(this.targetLayout, o),
                    h = !n && i;
                  if (
          ...
          startUpdate() {
            this.isUpdateBlocked() ||
              ((this.isUpdating = !0),
              this.nodes && this.nodes.forEach(Ao),
              this.animationId++);
          }
          ...
          update() {
            ...
            (this.isUpdating || this.nodes.forEach(fo),
              (this.isUpdating = !1),
              ...
              this.clearAllSnapshots());
            const t = rt.now();
            ((nt.delta = Bt(0, 1e3 / 60, t - nt.timestamp)),
              (nt.timestamp = t),
              (nt.isProcessing = !0),
              it.update.process(nt),
              it.preRender.process(nt),
              it.render.process(nt),
              (nt.isProcessing = !1));
          }
          didUpdate() {
            this.updateScheduled ||
              ((this.updateScheduled = !0), Ps.read(this.scheduleUpdate));
          }
          clearAllSnapshots() {
            (this.nodes.forEach(po), this.sharedNodes.forEach(Fo));
          }
          ...
          updateSnapshot() {
            !this.snapshot &&
              ...
              !this.snapshot ||
                Di(this.snapshot.measuredBox.x) ||
                Di(this.snapshot.measuredBox.y) ||
          ...
          resetTransform() {
            ...
            const t =
              ...
              e = this.projectionDelta && !qs(this.projectionDelta),
              n = this.getTransformTemplate(),
              i = n ? n(this.latestValues, "") : void 0,
              s = i !== this.prevTransformTemplateValue;
            t &&
              (e || Li(this.latestValues) || s) &&
              (r(this.instance, i),
              (this.shouldResetTransform = !1),
              this.scheduleRender());
          }
            ...
            if (
              !(
                (null === (t = this.scroll) || void 0 === t
                  ? void 0
                  : t.wasRoot) || this.path.some(Vo)
              )
            ) {
              const { scroll: t } = this.root;
              t && (Ki(n.x, t.offset.x), Ki(n.y, t.offset.y));
            }
            return n;
          }
          ...
          applyTransform(t) {
            ...
            for (let i = 0; i < this.path.length; i++) {
              ...
              (!e &&
                ...
                t.scroll &&
                t !== t.root &&
                Hi(n, { x: -t.scroll.offset.x, y: -t.scroll.offset.y }),
                Li(t.latestValues) && Hi(n, t.latestValues));
            }
            return (Li(this.latestValues) && Hi(n, this.latestValues), n);
          }
          removeTransform(t) {
            ...
            for (let n = 0; n < this.path.length; n++) {
              ...
              if (!Li(t.latestValues)) continue;
              Bi(t.latestValues) && t.updateSnapshot();
              const i = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } };
              (Ns(i, t.measurePageBox()),
                Hs(
                  e,
                  t.latestValues,
            ...
            return (Li(this.latestValues) && Hs(e, this.latestValues), e);
          }
          setTargetDelta(t) {
            ((this.targetDelta = t),
                ...
                if (
                  ...
                  this.relativeParent.target
                    ...
                    : this.targetDelta
                      ? (Boolean(this.resumingFrom)
                        ...
                        Wi(this.target, this.targetDelta))
                      : Ns(this.target, this.layout.layoutBox),
                  this.attemptToResolveRelativeTarget)
                ) {
                  ...
                  1 !== this.animationProgress
                    ? ((this.relativeParent = t),
                      ...
                      Vi(this.relativeTargetOrigin, this.target, t.target),
                      Ns(this.relativeTarget, this.relativeTargetOrigin))
                    : (this.relativeParent = this.relativeTarget = void 0);
                }
                Q.value && eo.calculatedTargetDeltas++;
              }
            }
          }
          ...
          calcProjection() {
            ...
            if (
              ...
              n &&
                ...
                (i = !1),
              this.resolvedRelativeTargetAt === nt.timestamp && (i = !1),
              i)
            )
              return;
            const { layout: s, layoutId: o } = this.options;
              ...
              for (let a = 0; a < s; a++) {
                ...
                (s && s.props.style && "contents" === s.props.style.display) ||
                  (i &&
                    ...
                    o.scroll &&
                    o !== o.root &&
                    Hi(t, { x: -o.scroll.offset.x, y: -o.scroll.offset.y }),
                  r && ((e.x *= r.x.scale), (e.y *= r.y.scale), Wi(t, r)),
                  i && Li(o.latestValues) && Hi(t, o.latestValues));
              }
              (e.x < Yi && e.x > zi && (e.x = 1),
                e.y < Yi && e.y > zi && (e.y = 1));
            ...
            l
              ? (this.projectionDelta && this.prevProjectionDelta
                  ? (Ws(this.prevProjectionDelta.x, this.projectionDelta.x),
                    Ws(this.prevProjectionDelta.y, this.projectionDelta.y))
                ...
                Q.value && eo.calculatedProjections++)
          ...
          setAnimationOrigin(t) {
            ...
            const a = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } },
              ...
              h = Boolean(
                l && !c && !0 === this.options.crossfade && !this.path.some(So),
              );
            let d;
            ((this.animationProgress = 0),
                ...
                (Po(r.x, t.x, n),
                  ...
                  this.relativeTarget &&
                    ...
                    d &&
                      ...
                      (u = d),
                      _s(s.x, u.x) && _s(s.y, u.y)) &&
                      (this.isProjectionDirty = !1),
                    d || (d = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }),
                    Ns(d, this.relativeTarget)),
                  l &&
                    ...
                    (function (t, e, n, i, s, o) {
                      ...
                      for (let r = 0; r < ks; r++) {
                        const s = "border".concat(Ms[r], "Radius");
                        let o = Ls(e, s),
                          a = Ls(n, s);
                        (void 0 === o && void 0 === a) ||
                          (o || (o = 0),
                          a || (a = 0),
                          0 === o || 0 === a || Bs(o) === Bs(a)
                            ? ((t[s] = Math.max(en(Rs(o), Rs(a), i), 0)),
                              (qt.test(a) || qt.test(o)) && (t[s] += "%"))
                            : (t[s] = a));
                      }
                      (e.rotate || n.rotate) &&
                        (t.rotate = en(e.rotate || 0, n.rotate || 0, i));
          ...
          applyTransformsToTarget() {
            ...
            if (e && n && i) {
              if (
                ...
                const e = Di(this.layout.layoutBox.x);
                ((n.x.min = t.target.x.min), (n.x.max = n.x.min + e));
                const i = Di(this.layout.layoutBox.y);
          ...
          resetSkewAndRotation() {
            ...
            if (
              ...
              return;
            const i = {};
            n.z && oo("z", t, i, this.animationValues);
            for (let s = 0; s < no.length; s++)
              (oo("rotate".concat(no[s]), t, i, this.animationValues),
                oo("skew".concat(no[s]), t, i, this.animationValues));
            t.render();
            for (const s in i)
              (t.setStaticValue(s, i[s]),
          ...
          getProjectionStyles(t) {
            ...
            if (this.needsReset)
              return (
                ...
                (i.opacity = ""),
                (i.pointerEvents =
                  Vs(null === t || void 0 === t ? void 0 : t.pointerEvents) ||
                  ""),
            ...
            (this.applyTransformsToTarget(),
              (i.transform = (function (t, e, n) {
                ...
                const s = t.x.translate / e.x,
                  o = t.y.translate / e.y,
                  r = (null === n || void 0 === n ? void 0 : n.z) || 0;
                if (
                  ((s || o || r) &&
                    (i = "translate3d("
                      .concat(s, "px, ")
            ...
            for (const u in Fs) {
              ...
              const { correct: t, applyTo: e, isCSSVariable: n } = Fs[u],
                s = "none" === i.transform ? r[u] : t(r[u], o);
              if (e) {
                const t = e.length;
                for (let n = 0; n < t; n++) i[e[n]] = s;
              } else
                n
                  ? (this.options.visualElement.renderState.vars[u] = s)
                  : (i[u] = s);
            }
            return (
              this.options.layoutId &&
                (i.pointerEvents =
                  o === this
                    ? Vs(
                        null === t || void 0 === t ? void 0 : t.pointerEvents,
                      ) || ""
                    : "none"),
              i
            );
      ...
      function uo(t) {
        ...
        if (t.isLead() && t.layout && n && t.hasListeners("didUpdate")) {
          ...
          o
            ? bi(a, t.applyTransform(i, !0), n.measuredBox)
            : bi(a, e, n.layoutBox);
          const l = !qs(r);
          let u = !1;
          if (!t.resumeFrom) {
      ...
      function To(t, e, n, i) {
        ((t.min = en(e.min, n.min, i)), (t.max = en(e.max, n.max, i)));
      }
      function So(t) {
      ...
      const Do = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        ...
        bo = wo("applewebkit/") && !wo("chrome/") ? Math.round : K;
      function Eo(t) {
        ((t.min = bo(t.min)), (t.max = bo(t.max)));
      }
      function Co(t, e, n) {
        return (
          "position" === t ||
          ("preserve-aspect" === t &&
            ((i = Qs(e)), (s = Qs(n)), (o = 0.2), !(Math.abs(i - s) <= o)))
        );
        var i, s, o;
      }
      function Vo(t) {
      ...
      const Mo = ao({
          attachResizeListener: (t, e) => Fi(t, "resize", e),
          measureScroll: () => ({
            ...
            Feature: class extends yi {
              ...
              createPanHandlers() {
                ...
                return {
                  ...
                  onMove: n,
                  onEnd: (t, e) => {
                    (delete this.session, i && tt.postRender(() => i(t, e)));
                  },
                };
              }
              mount() {
      ...
      function zo(t, e, n) {
        const i = (function (t) {
          ...
          return (
            o[a] ||
              (o[a] = new IntersectionObserver(Wo, (0, s.A)({ root: e }, n))),
            o[a]
          );
        })(e);
        return (
          ...
          i.observe(t),
          () => {
            (Io.delete(t), i.unobserve(t));
          }
        );
      }
      const Yo = { some: 0, all: 1 };
      const Ko = {
          inView: {
            Feature: class extends yi {
              constructor() {
              ...
              startObserver() {
                ...
                const { viewport: t = {} } = this.node.getProps(),
                  ...
                  o = {
                    ...
                    rootMargin: n,
                    threshold: "number" === typeof i ? i : Yo[i],
                  };
                return zo(this.node.current, o, (t) => {
                  const { isIntersecting: e } = t;
                  if (this.isInView === e) return;
                  if (((this.isInView = e), s && !e && this.hasEnteredView))
                    return;
              ...
              mount() {
                ...
                t &&
                  (this.unmount = W(
                    t,
                    (t, e) => (
                      jo(this.node, e, "Start"),
                      (t, e) => {
                        let { success: n } = e;
                        return jo(this.node, t, n ? "End" : "Cancel");
                      }
                    ),
              ...
              mount() {
                ...
                t &&
                  (this.unmount = (function (t, e) {
                    ...
                    t,
                    (t, e) => (
                      Lo(this.node, e, "Start"),
                      (t) => Lo(this.node, t, "End")
                    ),
                  ));
              }
              unmount() {}
        ...
        Xo = { layout: { ProjectionNode: Ro, MeasureLayout: Ds } },
        Ho = (0, ps.createContext)({ strict: !1 });
      var Go = n(1051);
      const qo = (0, ps.createContext)({});
      function _o(t) {
        return o(t.animate) || ai.some((e) => oi(t[e]));
      }
      function Zo(t) {
        return Boolean(_o(t) || t.variants);
      }
      function $o(t) {
        const { initial: e, animate: n } = (function (t, e) {
          if (_o(t)) {
            ...
            return {
              initial: !1 === e || oi(e) ? e : void 0,
              animate: oi(n) ? n : void 0,
            };
          }
          return !1 !== t.inherit ? e : {};
        })(t, (0, ps.useContext)(qo));
        return (0, ps.useMemo)(
          () => ({ initial: e, animate: n }),
          [Qo(e), Qo(n)],
        );
      ...
      const tr = {
        ...
        er = {};
      for (const aa in tr)
        er[aa] = { isEnabled: (t) => tr[aa].some((e) => !!t[e]) };
      const nr = Symbol.for("motionComponentSymbol");
      function ir(t, e, n) {
        return (0, ps.useCallback)(
          (i) => {
            (i && t.onMount && t.onMount(i),
              e && (i ? e.mount(i) : e.unmount()),
              n && ("function" === typeof n ? n(i) : qi(n) && (n.current = i)));
          },
          [e],
        );
      }
      ...
      function rr(t, e, n, i, s) {
        var o, r;
        const { visualElement: a } = (0, ps.useContext)(qo),
          l = (0, ps.useContext)(Ho),
          u = (0, ps.useContext)(sr.t),
          c = (0, ps.useContext)(Go.Q).reducedMotion,
          h = (0, ps.useRef)(null);
        ((i = i || l.renderer),
          !h.current &&
            i &&
          ...
          (function (t, e, n, i) {
            ...
            ((t.projection = new n(
              ...
              t.projection.setOptions({
                layoutId: s,
                layout: o,
                alwaysMeasureLayout: Boolean(r) || (a && qi(a)),
                visualElement: t,
        ...
        const m = (0, ps.useRef)(!1);
        (0, ps.useInsertionEffect)(() => {
      ...
      function ar(t) {
        if (t)
          return !1 !== t.options.allowProjection ? t.projection : ar(t.parent);
      }
      function lr(t) {
        let {
          preloadedFeatures: e,
        ...
        function u(t, e) {
          let a;
          const l = (0, s.A)(
              (0, s.A)((0, s.A)({}, (0, ps.useContext)(Go.Q)), t),
              {},
              { layoutId: ur(t) },
            ),
            { isStatic: u } = l,
          ...
          if (!u && Jo.B) {
            !(function () {
              (0, ps.useContext)(Ho).strict;
              0;
            })();
            const t = (function (t) {
              const { drag: e, layout: n } = er;
              if (!e && !n) return {};
              const i = (0, s.A)((0, s.A)({}, e), n);
              return {
                MeasureLayout:
                  (null === e || void 0 === e ? void 0 : e.isEnabled(t)) ||
                  (null === n || void 0 === n ? void 0 : n.isEnabled(t))
                    ? i.MeasureLayout
                    : void 0,
            ...
            ((a = t.MeasureLayout),
              (c.visualElement = rr(r, h, l, n, t.ProjectionNode)));
          }
          return (0, ds.jsxs)(qo.Provider, {
            value: c,
            children: [
              a && c.visualElement
                ? (0, ds.jsx)(
                    a,
                    (0, s.A)({ visualElement: c.visualElement }, l),
                  )
                : null,
              i(r, t, ir(h, c.visualElement, e), h, u, c.visualElement),
            ],
          });
        }
        (e &&
          (function (t) {
            for (const e in t) er[e] = (0, s.A)((0, s.A)({}, er[e]), t[e]);
          })(e),
        ...
        const c = (0, ps.forwardRef)(u);
        return ((c[nr] = r), c);
      }
      function ur(t) {
        let { layoutId: e } = t;
        const n = (0, ps.useContext)(fs.L).id;
      ...
      function cr(t, e) {
        ...
        return (
          H.has(t) ||
          t.startsWith("origin") ||
          ((n || void 0 !== i) && (!!Fs[t] || "opacity" === t))
        );
      }
      const hr = (t, e) => (e && "number" === typeof t ? e.transform(t) : t),
        dr = {
          x: "translateX",
          y: "translateY",
          z: "translateZ",
              ...
              ? (i.transform = (function (t, e, n) {
                  ...
                  for (let o = 0; o < pr; o++) {
                    ...
                    if (
                      ...
                      (l ||
                        ((s = !1),
                        (i += "".concat(dr[r] || r, "(").concat(t, ") "))),
                        n && (e[r] = t));
                    }
                  }
                  return (
                    (i = i.trim()),
                    n ? (i = n(e, s ? "" : i)) : s && (i = "none"),
                    i
                  );
                })(e, t.transform, n))
      ...
      function vr(t, e, n) {
        for (const i in e) vt(e[i]) || cr(i, n) || (t[i] = e[i]);
      }
      function gr(t, e) {
        const n = {};
        return (
          ...
          Object.assign(
            ...
            (function (t, e) {
              ...
              return (0, ps.useMemo)(() => {
                ...
                return (mr(t, e, n), Object.assign({}, t.vars, t.style));
              }, [e]);
            })(t, e),
          ),
          n
      ...
      try {
        (Pr = require("@emotion/is-prop-valid").default) &&
          (Fr = (t) => (t.startsWith("on") ? !Ar(t) : Pr(t)));
      } catch (ra) {}
      var Pr;
      const Tr = [
        "animate",
      ...
      function Sr(t) {
        return (
          "string" === typeof t &&
          !t.includes("-") &&
          !!(Tr.indexOf(t) > -1 || /[A-Z]/.test(t))
        );
      }
      const Dr = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
        wr = { offset: "strokeDashoffset", array: "strokeDasharray" };
      function br(t, e, n) {
        ...
        (p.transform && (f && (m.transform = p.transform), delete p.transform),
          f &&
            ...
            (m.transformOrigin = (function (t, e, n) {
              const i = br(e, t.x, t.width),
                s = br(n, t.y, t.height);
              return "".concat(i, " ").concat(s);
            })(f, void 0 !== l ? l : 0.5, void 0 !== u ? u : 0.5)),
          void 0 !== s && (p.x = s),
          void 0 !== o && (p.y = o),
          void 0 !== a && (p.scale = a),
          void 0 !== c &&
            (function (t, e) {
              ...
              t.pathLength = 1;
              const o = s ? Dr : wr;
              t[o.offset] = _t.transform(-i);
              const r = _t.transform(e),
                a = _t.transform(n);
              t[o.array] = "".concat(r, " ").concat(a);
            })(p, c, h, d, !1));
      }
      const Vr = () =>
          (0, s.A)(
        ...
        Mr = (t) => "string" === typeof t && "svg" === t.toLowerCase();
      function kr(t, e, n, i) {
        const o = (0, ps.useMemo)(() => {
          const n = Vr();
          return (
            Cr(n, e, Mr(i), t.transformTemplate),
            (0, s.A)(
              (0, s.A)({}, n.attrs),
              {},
              { style: (0, s.A)({}, n.style) },
        ...
        if (t.style) {
          const e = {};
          (vr(e, t.style, t), (o.style = (0, s.A)((0, s.A)({}, e), o.style)));
        }
        return o;
      }
      function Rr() {
        ...
        return (e, n, i, o, r) => {
          let { latestValues: a } = o;
          const l = (Sr(e) ? kr : yr)(n, a, r, e),
            u = (function (t, e, n) {
              const i = {};
              for (const s in t)
            ...
            c =
              e !== ps.Fragment
                ? (0, s.A)((0, s.A)((0, s.A)({}, u), l), {}, { ref: i })
                : {},
            { children: h } = n,
            d = (0, ps.useMemo)(() => (vt(h) ? h.get() : h), [h]);
          return (0, ps.createElement)(
            e,
            (0, s.A)((0, s.A)({}, c), {}, { children: d }),
          );
        };
      }
      var Br = n(4930);
      const Lr = ["transitionEnd", "transition"];
      const jr = (t) => (e, n) => {
        const i = (0, ps.useContext)(qo),
          o = (0, ps.useContext)(sr.t),
          r = () =>
            (function (t, e, n, i) {
              let {
              ...
              const l = { latestValues: Or(e, n, i, o), renderState: r() };
              return (
                a &&
                  ((l.onMount = (t) =>
                    a((0, s.A)({ props: e, current: t }, l))),
                  (l.onUpdate = (t) => a(t))),
                l
              );
            })(t, e, i, o);
      ...
      function Ir(t, e, n) {
        ...
        for (const r in s)
          (vt(s[r]) ||
            (e.style && vt(e.style[r])) ||
            cr(r, t) ||
            void 0 !==
              (null ===
                (i = null === n || void 0 === n ? void 0 : n.getValue(r)) ||
              void 0 === i
                ? void 0
                : i.liveStyle)) &&
            (o[r] = s[r]);
      ...
      function Wr(t, e, n, i) {
        let { style: s, vars: o } = e;
        Object.assign(t.style, s, i && i.getProjectionStyles(n));
        for (const r in o) t.style.setProperty(r, o[r]);
      }
      const zr = new Set([
        "baseFrequency",
        "diffuseConstant",
      ...
      function Yr(t, e, n, i) {
        ...
        for (const s in e.attrs)
          t.setAttribute(zr.has(s) ? s : yt(s), e.attrs[s]);
      }
      function Kr(t, e, n) {
        const i = Ir(t, e, n);
        for (const s in t)
      ...
      const Xr = ["x", "y", "width", "height", "cx", "cy", "r"],
        Hr = {
          useVisualState: jr({
            ...
            onUpdate: (t) => {
              ...
              a &&
                tt.read(() => {
                  (Nr(i, s),
                    tt.render(() => {
                      (Cr(s, o, Mr(i.tagName), e.transformTemplate), Yr(i, s));
                    }));
                });
            },
          }),
      ...
      class ta {
          ...
          ((this.current = null),
            ...
            (this.scheduleRender = () => {
              ...
              this.renderScheduledAt < t &&
                ((this.renderScheduledAt = t), tt.render(this.render, !1, !0));
            }));
          const { latestValues: c, renderState: h, onUpdate: d } = l;
          ((this.onUpdate = d),
            (this.latestValues = c),
            (this.baseTarget = (0, s.A)({}, c)),
            (this.initialValues = n.initial ? (0, s.A)({}, c) : {}),
            (this.renderState = h),
            (this.parent = e),
            (this.props = n),
            ...
            (this.isControllingVariants = _o(n)),
            (this.isVariantNode = Zo(n)),
        ...
        mount(t) {
          ((this.current = t),
            ...
            _r.current ||
              (function () {
                if (((_r.current = !0), Jo.B))
                  if (window.matchMedia) {
                    const t = window.matchMedia("(prefers-reduced-motion)"),
                      e = () => (qr.current = t.matches);
                    (t.addListener(e), e());
                  } else qr.current = !1;
              })(),
            (this.shouldReduceMotion =
              "never" !== this.reducedMotionConfig &&
              ("always" === this.reducedMotionConfig || qr.current)),
            this.parent && this.parent.children.add(this),
        ...
        update(t, e) {
          ...
          ((this.prevMotionValues = (function (t, e, n) {
            for (const i in e) {
              const s = e[i],
                o = n[i];
              if (vt(s)) t.addValue(i, s);
              else if (vt(o)) t.addValue(i, pt(s, { owner: t }));
              else if (o !== s)
                if (t.hasValue(i)) {
                  ...
                  t.addValue(i, pt(void 0 !== e ? e : s, { owner: t }));
                }
            }
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === n &&
              void 0 !== e &&
              ((n = pt(null === e ? void 0 : e, { owner: this })),
              this.addValue(t, n)),
            n
          );
        }
        readValue(t, e) {
          ...
          return (
            void 0 !== i &&
              null !== i &&
              ("string" === typeof i && (je(i) || Rt(i))
                ? (i = parseFloat(i))
                : ((s = i), !Zr.find(Ke(s)) && ue.test(e) && (i = Ae(t, e))),
              this.setBaseTarget(t, vt(i) ? i.get() : i)),
            vt(i) ? i.get() : i
          );
        }
        setBaseTarget(t, e) {
        ...
        readValueFromInstance(t, e) {
          ...
          }
          {
            const i = ((n = t), window.getComputedStyle(n)),
              s = (Ie(e) ? i.getPropertyValue(e) : i[e]) || 0;
      ...
      class ia extends ea {
        constructor() {
          (super(...arguments),
            (this.type = "svg"),
            (this.isSVGTag = !1),
            (this.measureInstanceViewportBox = Mi),
            (this.updateDimensions = () => {
              this.current &&
                !this.renderState.dimensions &&
                Nr(this.current, this.renderState);
            }));
        }
        getBaseTargetFromProps(t, e) {
          return t[e];
        ...
        readValueFromInstance(t, e) {
          ...
          return ((e = zr.has(e) ? e : yt(e)), t.getAttribute(e));
        }
        scrapeMotionValuesFromProps(t, e, n) {
          return Kr(t, e, n);
        }
        onBindTransform() {
          this.current &&
            !this.renderState.dimensions &&
            tt.postRender(this.updateDimensions);
        }
        build(t, e, n) {
          Cr(t, e, this.isSVGTag, n.transformTemplate);
        }
      ...
      const sa = (t, e) =>
          Sr(t) ? new ia(e) : new na(e, { allowProjection: t !== ps.Fragment }),
        oa = i(
          Gr((0, s.A)((0, s.A)((0, s.A)((0, s.A)({}, Ai), Ko), Bo), Xo), sa),
        );
    },
    4735: (t, e, n) => {
      n.d(e, { B: () => i });
    ...
    293: (t, e, n) => {
      n.d(e, { E: () => s });
      var i = n(5043);
      const s = n(4735).B ? i.useLayoutEffect : i.useEffect;
    },
  },
]);
//# sourceMappingURL=4694.ab5b411a.chunk.js.map
