/*! For license information please see 7904.dc7dea1c.chunk.js.LICENSE.txt */
  ...
  [7904],
  {
    ...
    5874: (t, e, n) => {
      ...
      var o = n(9662),
        c = n(579);
      const r = (0, o.A)(
        (0, c.jsx)("path", { d: "M2.01 21 23 12 2.01 3 2 10l15 2-15 2z" }),
        "Send",
      );
    },
    9834: (t, e, n) => {
      ...
      t.exports = function (t, e, n) {
        ...
        return (
          (window[s] = function (t) {
            (o("jsonp got", t), w(), n && n(null, t));
          }),
          (t = (t += (~t.indexOf("?") ? "&" : "?") + u + "=" + h(s)).replace(
            "?&",
            "?",
          )),
          o('jsonp req "%s"', t),
    ...
    1260: (t, e, n) => {
        ...
        return (
          !t &&
            ...
            (t = {
              ...
              REACT_APP_VERSION: "2.0.19",
              REACT_APP_HOST:
                "https://rup4a04-c02.tos-cn-hongkong.bytepluses.com/newsvr-2025.txt",
              REACT_APP_HOST_BACKUP:
                "https://rup4a04-c01.tos-ap-southeast-1.bytepluses.com/newsvr-2025.txt",
              REACT_APP_HOST_BACKUP_SECOND:
                "https://rup4a04-c03.tos-cn-beijing.bytepluses.com.cn/newsvr-2025.txt",
              REACT_APP_COMIC_WEB_URL: "https://18comic.vip/",
              REACT_APP_HOST_BACKUP_CODE:
      ...
      (((e = t.exports = n(4703)).log = function () {
        return (
    ...
    4703: (t, e, n) => {
        ...
        function n() {
          if (n.enabled) {
            var t = n,
              c = +new Date(),
              r = c - (o || c);
            ((t.diff = r), (t.prev = o), (t.curr = c), (o = c));
            ...
            ((i[0] = i[0].replace(/%([a-zA-Z%])/g, function (n, o) {
              if ("%%" === n) return n;
              l++;
              var c = e.formatters[o];
              if ("function" === typeof c) {
                var r = i[l];
                ((n = c.call(t, r)), i.splice(l, 1), l--);
              }
              return n;
            })),
      ...
      (((e = t.exports = c.debug = c.default = c).coerce = function (t) {
        ...
        if ("number" === s && !1 === isNaN(t))
          return a.long
            ? i((l = t), c, "day") ||
                ...
                l + " ms"
            : (function (t) {
                if (t >= c) return Math.round(t / c) + "d";
    ...
    8139: (t, e) => {
      ...
      !(function () {
        ...
        function r(t) {
          ...
          if (Array.isArray(t)) return c.apply(null, t);
          if (
    ...
    519: (t, e, n) => {
      ...
      var o = n(579),
        ...
        p = (t, e, n) =>
          e in t
            ...
            : (t[e] = n),
        w = (t, e) => {
          for (var n in e || (e = {})) d.call(e, n) && p(t, n, e[n]);
          if (u) for (var n of u(e)) h.call(e, n) && p(t, n, e[n]);
          return t;
        },
        C = (t, e) => l(t, s(e)),
        m = (t, e) => {
          var n = {};
          for (var o in t) d.call(t, o) && e.indexOf(o) < 0 && (n[o] = t[o]);
          if (null != t && u)
            for (var o of u(t))
              e.indexOf(o) < 0 && h.call(t, o) && (n[o] = t[o]);
          return n;
        };
      function f(t) {
        return (e) => {
          ...
          return (0, o.jsxs)(
            "svg",
            C(w({ viewBox: "0 0 64 64", width: l, height: l }, s), {
              children: [
                a
                  ? (0, o.jsx)("circle", {
                      cx: "32",
      ...
      function k(t, e, n, r) {
        ...
        return (
          (i.displayName = "ShareButton-".concat(t)),
          (0, c.forwardRef)(i)
        );
      }
      const y = k(
          "email",
          function (t, e) {
            let { subject: n, body: o, separator: c } = e;
            return "mailto:" + v({ subject: n, body: o ? o + c + t : t });
          },
          (t) => ({
            subject: t.subject,
            body: t.body,
      ...
      const S = k(
        "facebookmessenger",
        function (t, e) {
          let { appId: n, redirectUri: o, to: c } = e;
          return (
            "https://www.facebook.com/dialog/send" +
            v({ link: t, redirect_uri: o || t, app_id: n, to: c })
          );
        },
        (t) => ({ appId: t.appId, redirectUri: t.redirectUri, to: t.to }),
      ...
      function H(t) {
        var e = t,
          { children: n = (t) => t, className: i, getCount: a, url: l } = e,
          s = m(e, ["children", "className", "getCount", "url"]);
        const u = (function () {
            ...
            return (
              ...
              (0, c.useCallback)(() => t.current, [])
            );
          })(),
          [d, h] = (0, c.useState)(void 0),
          [p, f] = (0, c.useState)(!1);
        return (
          (0, c.useEffect)(() => {
            (f(!0),
          ...
          (0, o.jsx)(
            "span",
            C(w({ className: r("react-share__ShareCount", i) }, s), {
              children: !p && void 0 !== d && n(d),
            }),
          )
        );
      }
      function N(t) {
        const e = (e) => (0, o.jsx)(H, w({ getCount: t }, e));
        return ((e.displayName = "ShareCount(".concat(t.name, ")")), e);
      }
      (N(function (t, e) {
        ...
        i(n, (t, n) => {
          e(
            !t && n && n.og_object && n.og_object.engagement
      ...
      (N(function (t, e) {
        i(
          "https://bookmark.hatenaapis.com/count/entry" + v({ url: t }),
          (t, n) => {
            e(null != n ? n : void 0);
          },
        );
      ...
      (k(
        "linkedin",
        function (t, e) {
          let { title: n, summary: o, source: c } = e;
          return (
            x(t, "linkedin.url"),
            "https://linkedin.com/shareArticle" +
              v({ url: t, mini: "true", title: n, summary: o, source: c })
          );
        },
        (t) => {
          let { title: e, summary: n, source: o } = t;
          return { title: e, summary: n, source: o };
        },
      ...
      (k(
        "mailru",
        function (t, e) {
          let { title: n, description: o, imageUrl: c } = e;
          return (
            x(t, "mailru.url"),
            "https://connect.mail.ru/share" +
              v({ url: t, title: n, description: o, image_url: c })
          );
        },
        (t) => ({
          title: t.title,
      ...
      k(
        "ok",
        function (t, e) {
          let { title: n, description: o, image: c } = e;
          return (
            x(t, "ok.url"),
            "https://connect.ok.ru/offer" +
              v({ url: t, title: n, description: o, imageUrl: c })
          );
        },
        (t) => ({ title: t.title, description: t.description, image: t.image }),
        ...
        window.OK ||
          (window.OK = {
            Share: {
              count: function (t, e) {
                var n, o;
                null == (o = (n = window.OK.callbacks)[t]) || o.call(n, e);
              },
            },
            callbacks: [],
          });
          ...
          (window.ODKL = {
            updateCount(t, e) {
              ...
              null == (o = (n = window.OK.callbacks)[c]) ||
                o.call(n, "" === e ? void 0 : parseInt(e, 10));
            },
          }),
          window.OK.callbacks.push(e),
          i(
            "https://connect.ok.ru/dk" +
              v({ "st.cmd": "extLike", uid: "react-share-".concat(n), ref: t }),
          )
        );
      }),
        f({
      ...
      k(
        "pinterest",
        function (t, e) {
          let { media: n, description: o, pinId: c } = e;
          return c
            ? "https://pinterest.com/pin/".concat(c, "/repin/x/")
            : (x(t, "pinterest.url"),
              x(n, "pinterest.media"),
              "https://pinterest.com/pin/create/button/" +
                v({ url: t, media: n, description: o }));
        },
        (t) => ({ media: t.media, description: t.description, pinId: t.pinId }),
        { windowWidth: 1e3, windowHeight: 730 },
      );
      (N(function (t, e) {
        i(
          "https://api.pinterest.com/v1/urls/count.json" + v({ url: t }),
          (t, n) => {
            e(n ? n.count : void 0);
          },
        );
      ...
      (k(
        ...
        function (t, e) {
          ...
          return (
            x(t, "pocket.url"),
            "https://getpocket.com/save" + v({ url: t, title: n })
          );
        },
        (t) => ({ title: t.title }),
        { windowWidth: 500, windowHeight: 500 },
      ...
      k(
        ...
        function (t, e) {
          ...
          return (
            x(t, "reddit.url"),
            "https://www.reddit.com/submit" + v({ url: t, title: n })
          );
        },
        (t) => ({ title: t.title }),
        { windowWidth: 660, windowHeight: 460, windowPosition: "windowCenter" },
      ...
      (k(
        ...
        function (t, e) {
          ...
          return (
            x(t, "gab.url"),
            "https://gab.com/compose" + v({ url: t, text: n })
          );
        },
        (t) => ({ title: t.title }),
      ...
      N(function (t, e) {
        const n = "https://www.reddit.com/api/info.json?limit=1&url=".concat(t);
        i(n, { param: "jsonp" }, (t, n) => {
          e(
            !t &&
              n &&
      ...
      const z = k(
        ...
        function (t, e) {
          ...
          return (
            x(t, "telegram.url"),
            "https://telegram.me/share/url" + v({ url: t, text: n })
          );
        },
        (t) => ({ title: t.title }),
        { windowWidth: 550, windowHeight: 400 },
      ...
      k(
        "tumblr",
        function (t, e) {
          let { title: n, caption: o, tags: c, posttype: r } = e;
          return (
            x(t, "tumblr.url"),
            "https://www.tumblr.com/widgets/share/tool" +
              v({ canonicalUrl: t, title: n, caption: o, tags: c, posttype: r })
          );
        },
        (t) => ({
          title: t.title,
      ...
      (N(function (t, e) {
        return i(
          "https://api.tumblr.com/v2/share/stats" + v({ url: t }),
          (t, n) => {
      ...
      (k(
        "twitter",
        function (t, e) {
          let { title: n, via: o, hashtags: c = [], related: r = [] } = e;
          return (
            x(t, "twitter.url"),
            x(Array.isArray(c), "twitter.hashtags is not an array"),
            x(Array.isArray(r), "twitter.related is not an array"),
      ...
      (k(
        "viber",
        function (t, e) {
          let { title: n, separator: o } = e;
          return (
            x(t, "viber.url"),
            "viber://forward" + v({ text: n ? n + o + t : t })
          );
        },
        (t) => ({ title: t.title, separator: t.separator || " " }),
        { windowWidth: 660, windowHeight: 460 },
      ),
        f({
          color: "#4C75A3",
      ...
      k(
        "vk",
        function (t, e) {
          let { title: n, image: o, noParse: c, noVkLinks: r } = e;
          return (
            x(t, "vk.url"),
      ...
      (N(function (t, e) {
        (window.VK || (window.VK = {}),
          (window.VK.Share = {
            count: (t, e) => {
              var n, o;
              return null ==
                (o = null == (n = window.VK.callbacks) ? void 0 : n[t])
                ? void 0
                : o.call(n, e);
            },
          }),
        ...
        return (
          ...
          i("https://vk.com/share.php" + v({ act: "count", index: n, url: t }))
        );
      }),
        f({
          color: "#DF2029",
      ...
      k(
        "weibo",
        function (t, e) {
          let { title: n, image: o } = e;
          return (
            x(t, "weibo.url"),
            "http://service.weibo.com/share/share.php" +
              v({ url: t, title: n, pic: o })
          );
        },
        (t) => ({ title: t.title, image: t.image }),
      ...
      (k(
        "workplace",
        function (t, e) {
          let { quote: n, hashtag: o } = e;
          return (
            x(t, "workplace.url"),
            "https://work.facebook.com/sharer.php" +
              v({ u: t, quote: n, hashtag: o })
          );
        },
        (t) => ({ quote: t.quote, hashtag: t.hashtag }),
        { windowWidth: 550, windowHeight: 400 },
      ),
        f({
          color: "#000000",
...
//# sourceMappingURL=7904.dc7dea1c.chunk.js.map
