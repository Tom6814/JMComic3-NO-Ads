  ...
  [6209],
  {
    9011: (e, t, s) => {
      ...
      const n = (e) => {
          ...
          return (0, i.jsx)(r.N_, {
            ...
            onClick: (e) => {
              (e.preventDefault(),
                "number" === typeof t ? o(t) : o(t, { state: s }));
            },
            ...
            return (0, d.jsx)(
              i.A,
              {
                ...
                onClose: (t, o) => {
                  var r;
                  "clickaway" !== o &&
                    ((r = e.key), s((e) => e.filter((e) => e.key !== r)));
                },
    ...
    3492: (e, t, s) => {
      ...
      const b = (e) => {
        const {
          ...
          M = (0, i.j)(),
          { favoriteList: O } = (0, i.G)((e) => e.member),
          D = (0, r.useRef)(null),
          B = (0, r.useRef)(!1),
          P = JSON.parse(localStorage.getItem("likedItems") || "[]"),
          [W, R] = (0, r.useState)(!1),
          [H, J] = (0, r.useState)(() => {
          ...
          Z = () => {
            ((B.current = !0), clearTimeout(D.current));
          },
          q = async (e, s) => {
            if ("like" === e) {
              if (P.includes(s))
                return void E(t("snack.already_rated"), "success");
              localStorage.setItem("likedItems", JSON.stringify([...P, s]));
              const e = await M((0, m.c1)({ id: s })).unwrap(),
                { code: o, msg: r, status: a } = e.data;
              200 === o && E(r, "success" !== a ? "error" : "success");
            }
            if ("mark" === e)
              if (b) {
                (R(!0),
                    ...
                    J((s) => {
                      const r = s[e] || [],
                        a = r.includes(t)
                          ? r.filter((e) => e !== t)
                          : [...r, t];
                      return (0, o.A)((0, o.A)({}, s), {}, { [e]: a });
                    });
                  })("mark", s));
                const e = await M((0, m.df)(s)).unwrap(),
                  { code: t, data: r } = e,
                  a = "ok" !== r.status ? "error" : "success";
                if ("ok" === r.status)
                  switch (r.type) {
                    case "add":
                    case "edit":
                    case "move":
                      (L((e) =>
                        (0, o.A)((0, o.A)({}, e), {}, { aid: s, alert: !1 }),
                      ),
                        F((0, o.A)((0, o.A)({}, z), {}, { folder: !0 })));
                      break;
                    case "remove":
                      L((e) => (0, o.A)((0, o.A)({}, e), x.x));
                  }
                E(r.msg, a);
              } else
                (E(t("login.please_login"), "error"),
                  F((0, o.A)((0, o.A)({}, z), {}, { login: !0 })));
          },
          U = () => {
            M((0, u.a9)("favoriteList"));
            const { folder_id: e, o: t } = T;
            M((0, m.an)({ page: 1, folder_id: e, o: t }));
          },
          Y = async (e) => {
            (R(!0),
              "del" === e && F((0, o.A)((0, o.A)({}, z), {}, { alert: !0 })));
            const { folder_id: s, folder_name: r, aid: a } = T;
            if ("" !== r) {
              const t = await M(
                  (0, m.Je)({ type: e, folder_id: s, folder_name: r, aid: a }),
                ).unwrap(),
                { status: o, msg: i } = t.data;
              o && i && E(i, "ok" !== o ? "error" : "success");
            } else E(t("comic.added_to_favorites_success"), "success");
            L((e) => (0, o.A)((0, o.A)({}, e), x.x));
          };
              ...
              (0, f.jsx)(p.Fc, {
                ...
                handleDelWatchComic: async () => {
                  if ("del_watch_history" === T.type && "" !== T.aid) {
                    const e = await M((0, m.Zx)(T.aid)).unwrap(),
                      { status: t, msg: s } = e;
                    (E(s, 1 !== t ? "error" : "success"),
                      L((e) => (0, o.A)((0, o.A)({}, e), x.x)),
                      M((0, m.gW)(1)));
                  }
                },
    ...
    3344: (e, t, s) => {
      ...
      const k = r.forwardRef(function (e, t) {
          return (0, v.jsx)(u.A, (0, o.A)({ direction: "up", ref: t }, e));
        }),
        j = (e) => {
          const {
              dialogOpen: t,
            ...
            T =
              ...
              u.tags_select === y.toString(),
            L = (e, r) => {
              "backdropClick" !== r &&
                s((0, o.A)((0, o.A)({}, t), {}, { folder: !1 }));
            };
                            ...
                            (0, v.jsxs)(l.A, {
                              ...
                              children: [
                                (0, v.jsx)("span", {
                                  className: "pr-10",
                                  children:
                                    u.folder_name || C("member.select_folder"),
                                }),
                                (0, v.jsx)(g.A, {
    ...
    6209: (e, t, s) => {
      ...
      const A = () => {
        var e, t;
        const { config: s } = (0, d.H)(),
          { setting: A, logined: w, darkMode: y } = s,
          { t: _ } = ((0, a.zy)(), (0, i.Bd)()),
          N = (0, l.j)(),
          { snackbars: S, setSnackbars: C, showSnackbar: T } = (0, k.q)(),
          {
            weekList: L,
            weekFilterList: E,
            isLoading: F,
          } = (0, l.G)((e) => e.week),
          { editResult: z } = (0, l.G)((e) => e.member),
          [I, M] = (0, r.useState)({
            selectType: "",
            episode: "",
            categoriesId: "",
          }),
          [O, D] = (0, r.useState)({ folder: !1 }),
          [B, P] = (0, r.useState)(b.x),
          [W, R] = r.useState(null);
        (0, r.useEffect)(() => {
          N((0, h.l)());
        }, [N]);
        ...
        return (
          (0, r.useEffect)(() => {
            I.categoriesId &&
              I.selectType &&
              N((0, h.a)({ id: I.categoriesId, type: I.selectType }));
          }, [I, N]),
          (0, r.useEffect)(() => {
            if (L.type && L.categories) {
              const e = L.type[2].id,
                t = L.categories[0];
              H({ selectType: e, episode: t.time, categoriesId: t.id });
            }
          }, [L]),
          (0, j.jsxs)("div", {
            className: "h-full",
            children: [
              F && (0, j.jsx)(p.A, {}),
              (0, j.jsxs)("div", {
                className: "sticky top-safe z-50",
                children: [
                  (0, j.jsxs)("div", {
                    className:
                      "sticky top-0 h-20 bg-bbk text-white flex items-end p-2 py-3",
                    children: [
                      (0, j.jsx)(f.ee, {
                      ...
                      (0, j.jsx)("p", {
                        ...
                        children: _("comic.must_watch"),
                      }),
                      (0, j.jsx)("span", {
                        className: "ml-5",
                        children: _("comic.update_time"),
                      }),
                    ],
                  }),
                  (0, j.jsxs)("div", {
                    className: "bg-defaultBg py-1 dark:bg-nbk",
                    children: [
                      (0, j.jsx)(n.A, {
                        className:
                          "w-full flex justify-between bg-transparent text-lg text-gy py-4",
                        id: "demo-customized-button",
                        "aria-controls": Boolean(W)
                          ? "demo-customized-menu"
                          : void 0,
                        "aria-haspopup": "true",
                        "aria-expanded": Boolean(W) ? "true" : void 0,
                        variant: "contained",
                        disableElevation: !0,
                        onClick: (e) => R(e.currentTarget),
                        endIcon: (0, j.jsx)(u.A, {
                          className: "text-og text-3xl",
                        }),
                        children: I.episode,
                      }),
                      (0, j.jsx)(c.A, {
                        ...
                        sx: (e) => ({
                          "& .MuiPaper-root": {
                            ...
                            marginLeft: e.spacing(-2),
                            width: "80%",
                            color: y ? "#d1d1d1" : "#323232",
                            backgroundColor: y ? "#121212" : "",
                          },
                        }),
                        children:
                          (null === (e = L.categories) || void 0 === e
                            ? void 0
                            : e.length) > 0 &&
                          L.categories.map((e) =>
                            (0, j.jsx)(
                              m.A,
                              {
                                onClick: () => {
                                  (R(null),
                                    H({ categoriesId: e.id, episode: e.time }));
                                },
                                children: e.time,
                              },
                              e.id,
              ...
              (0, j.jsx)(g.A, {}),
              (0, j.jsx)(k.A, { snackbars: S, setSnackbars: C }),
            ],
          })
        );
      };
...
//# sourceMappingURL=6209.c70e0877.chunk.js.map
